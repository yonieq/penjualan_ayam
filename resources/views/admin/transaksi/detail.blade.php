                  ...
                  <div class="card-body">
                   ...
                   <div class="col-md-7">
                    <table>
                        ...
                        @if($order->nama_pengantar != null)
                        <tr>
                            <td>Nama Pengantar</td>
                            <td>:</td>
                            <td  class="p-2">{{ $order->nama_pengantar }}</td>
                        </tr>
                        @endif
                        @if($order->nama_pengantar != null)
                        <tr>
                            <td>No Pengantar</td>
                            <td>:</td>
                            <td  class="p-2">{{ $order->no_pengantar }}</td>
                        </tr>
                        @endif
                        <tr>
                            <td>No Hp</td>
                        ...
                        <tr>
                            ...
                            {{-- <div class="input-group"> --}}
                              <label for="fname">Nama Pengantar:</label><br>
                              <input type="text" class="form-control form-control-sm" placeholder="" aria-label="Recipient's username" aria-describedby="basic-addon2" name="nama_pengantar" required></br>
                              <label for="lname">No. Pengantar:</label><br>
                              <input type="text" class="form-control form-control-sm" placeholder="" aria-label="Recipient's username" aria-describedby="basic-addon2" name="no_pengantar" required></br>
