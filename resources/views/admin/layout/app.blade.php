...
<html lang="en">
  <head>
    ...
    <title>Admin Penjualan Ayam</title>
    <!-- plugins:css -->
    ...
    <link rel="shortcut icon" href="{{ asset('shopper') }}/images/ayam.png" />
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          ...
          <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{ asset('shopper') }}/images/ayam.png" alt="logo" /></a>
        </div>
            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <div class="nav-profile-img">
                  <img src="{{ asset('shopper') }}/images/ayam.png" alt="image">
                  <span class="availability-status online"></span>
                </div>
                <div class="nav-profile-text">
                  <p class="mb-1 text-black">Admin Penjual Ayam</p>
                </div>
              </a>
          ...
          <ul class="nav">
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                <div class="nav-profile-image">
                  <img src="{{ asset('shopper') }}/images/ayam.png" alt="profile">
                  <span class="login-status online"></span>
                  <!--change to offline or busy as needed-->
                </div>
                <div class="nav-profile-text d-flex flex-column">
                  <span class="font-weight-bold mb-2">Penjual Ayam</span>
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.laporan') }}">
                ...
                <i class="mdi mdi mdi-file-account menu-icon"></i>
              </a>
            </li>
            <li class="nav-item ">
