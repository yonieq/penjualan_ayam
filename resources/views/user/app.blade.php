                    ...
                    @auth
                        <li>
                          <div class="dropdown">
                            ...
                            <span class="icon icon-person" title="Akun Setting"></span>
                            </a>
                        ...
                        <li>
                          ...
                          ?>
                            ...
                            <span class="icon icon-add_shopping_cart" title="Keranjang"></span>
                        ...
                        <a href="{{ route('user.order') }}" class="site-cart">
                            <span class="icon icon-shopping_cart" title="Order"></span>
      ...
      <div class="container">
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Copyright &copy;<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>document.write(new Date().getFullYear());</script> <i class="icon-heart" aria-hidden="true"></i> by <a href="/" target="_blank" class="text-primary">Bintang Rasa</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
