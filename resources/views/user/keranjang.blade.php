...
<div class="site-section">
        ...
        @csrf
            ...
            <tbody>
                ...
                <td>
                    ...
                    <input type="number" name="qty[]" class="form-control text-center" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1" value="{{ $keranjang->qty }}">
                ...
                <td><a href="{{ route('user.keranjang.delete',['id' => $keranjang->id]) }}" class="btn btn-danger btn-sm" title="Hapus Dari Keranjang">X</a></td>
                </tr>
                <?php endforeach;?>
            </tbody>
            </table>
    ...
    <div class="row">
        ...
        <div class="row mb-5">
            ...
            <a href="/produk" class="btn btn-warning btn-lg py-3 btn-block" >Lanjut Belanja</a>
            </div>
            </form>       
        </div>
        </div>
