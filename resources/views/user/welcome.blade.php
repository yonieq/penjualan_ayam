@extends('user.app')
@section('content')
<div class="site-blocks-cover" style="background-image: url({{ asset('shopper') }}/images/catering_1.jpg);" data-aos="fade">
    <div class="container">
    <div class="row align-items-start align-items-md-center justify-content-end">
        <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
        <h1 class="mb-2">Cari Kebutuhan Dapur Anda Di Sini</h1>
        <div class="intro-text text-center text-md-left">
            <p class="mb-4">Makanan disini terjamin kualitasnya dan tentunya sehat, bergizi. </p>
            <p>
...
<div class="site-section site-section-sm site-blocks-1">
    ...
    <div class="row">
        ...
        <div class="text">
            ...
            <p>Kualitas makanan sehat dan bergizi tinggi</p>
        </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="nonloop-block-3 owl-carousel" >
            ...
            <div class="block-4 text-center">
                ...
                <img src="{{ asset('imageproduct/'.$produk->image) }}" alt="Image placeholder" class="img-fluid" width="100%" style="height:300px">
                </figure>
                </a>
